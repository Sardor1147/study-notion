...
export default function DeleteAccount() {
    ...
    return(
        <>
            <div className="flex flex-row my-10 gap-x-5 rounded-md border-[1px] border-pink-700 bg-pink-900 p-8 px-6 sm:px-12">
                ...
                <div className="flex flex-col">
                    ...
                    <div className="sm:w-3/5 text-pink-25 flex flex-col gap-3 mt-1">
                        <p>Would you like to delete your accout ?</p>
                        <p>This account may contain Paid courses. Deleting your accout is permanent and will remove all the contain associated with it</p>
                    </div>
