...
export default function VideoDetailsSidebar({ setReviewModal }){
    ...
    const [videBarActive, setVideoBarActive] = useState("")
    ...
    return (
        <>
            <div className="flex h-[calc(100vh-3.5rem)] w-[320px] max-w-[350px] flex-col border-r-[1px] border-r-richblack-700 bg-richblack-800">
                <div className="mx-5 flex flex-col items-start justify-between gap-2 gap-y-4 border-b border-richblack-600
                ...
                <div className="h-[clacl(100vh-5rem)] overflow-y-auto">
                            ...
                            {activeStatus === section?._id && (
                                <div className="transition-[height] duration-500 ease-in-out">
                                    {section.subSection.map((topic, i) => (
                                        <div 
                                            className={`flex gap-3 px-5 py-2 ${setVideoBarActive === topic._id
